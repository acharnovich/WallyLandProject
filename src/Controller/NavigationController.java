...
/**
 * This is the default constructor that initiates other controllers to open user interfaces.
 */
    ...
    public NavigationController()
    {
       ...
       navView.getPurchaseButton().addActionListener(this);
 ...
 * @param event will be pass as a parameter to initialize corresponding controllers.
 */
    @Override
 ...
 /**
 * Opens the UI for the user to view attractions.
 * @param event will be pass as a parameter to initialize corresponding controllers.
 */   
    public void attractionsButtonClicked(){
 ...
 * @param event will be passes as a parameter to initialized corresponding controllers.
 */
