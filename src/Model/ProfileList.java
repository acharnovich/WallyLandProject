 ...
 */
    ...
    public String loadData(){
        UserAccount testProfile = new UserAccount("Bob Test", "bobtest@gmail.com", "02/19/1978", 123456, "bobtest", "1234",true, new ArrayList<>(), new ArrayList<>(), new ArrayList<parkTicket>(), new ArrayList<SitDownReservation>(), new ArrayList<parkTicket>());
